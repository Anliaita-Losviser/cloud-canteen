...
//        );
    ...
    public void paySuccess(String outTradeNo) {
        ...
        // 根据订单号查询订单
        Orders ordersDB = orderDAO.findByNumber(outTradeNo);
        ...
        //websocket推送消息给客户端type OrderId Content
        Map map = new HashMap<>();
...
//                    new BigDecimal(0.01));//原订单金额
    ...
    public OrderStatisticsVO statistics() {
        ...
        Integer toBeConfirmed = orderDAO.countByStatus(Orders.TO_BE_CONFIRMED);
        Integer confirmed = orderDAO.countByStatus(Orders.CONFIRMED);
        Integer deliveryInProgress = orderDAO.countByStatus(Orders.DELIVERY_IN_PROGRESS);
    ...
    public void rejection(OrdersRejectionDTO ordersRejectionDTO) {
        // 根据id查询订单
        Orders ordersDB = orderDAO.findById(ordersRejectionDTO.getId()).get();
...
//            log.info("申请退款：{}", refund);
    ...
    public void cancel(OrdersCancelDTO ordersCancelDTO) {
        // 根据id查询订单
        Orders ordersDB = orderDAO.findById(ordersCancelDTO.getId()).get();
